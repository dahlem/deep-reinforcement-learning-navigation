...
class Agent(nn.Module):
    def __init__(self, params):
        ...
        self.activations = params['agent_params']['network_params'].get('activations', None)
    ...
    def evaluate(self, weights, policy):
        ...
        for t in range(self.max_t):
            ...
            action = policy.apply(self.forward(state).cpu().data.numpy())
